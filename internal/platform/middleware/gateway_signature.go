...
//
// It MUST be registered BEFORE Auth + RequireValidIdentity on the protected group so
// that no handler trusts identity headers until the signature is validated.
//
