// Package middleware provides Gin middleware for the user service.
package middleware
...
// requestIDPattern accepts only safe characters to prevent header/log injection (F10).
...
// invalid values are replaced with a fresh UUID to prevent header/log injection (F10).
